# Conversion audit — educational-policy-analysis
...
- Inline style attributes converted to classes: 41 occurrences, 15 distinct declarations.
...
- Buttons given an explicit type: 6; tables given a <tbody>: 2; <th> given a scope: 10; raw ampersands encoded: 2; top navigation given an accessible name.
- Sections with ids: 16 (what, process, decision, logicmodel, frameworks, criteria, resources, equity, eightfold, instruments, cba, stakeholders, toc, implementation, memo, glossary).
